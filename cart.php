...
<body background="i5.jpg" style="background-repeat: no-repeat; background-attachment: fixed; 
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="checkout.php" style="background-color:peru; color:white" class="btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>"><i class="far fa-credit-card"></i>&nbsp;&nbsp;Checkout</a>
                </td>
              </tr>
            </tbody>
          </table>

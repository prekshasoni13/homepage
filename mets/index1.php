...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <a class="navbar-brand" href="#"><img src="./image/logo 3.jpg" alt="logo"></a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="#">Showpiece</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownGalleryLink">
                        <li><a class="dropdown-item" href="#">Wall Gallery</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownHomeDecorLink">
                        <li><a class="dropdown-item" href="#">Cushion Cover</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownHomeFurnishingLink">
                        <li><a class="dropdown-item" href="#">Mats and Rugs</a></li>
                        <li><a class="dropdown-item" href="#">Multipurpose Cabinets</a></li>
                    </ul>
                </li>
        ...
        <div class="navbar-icons">
            <a href="#" class="nav-icon"><img src="./image/call img.png" alt="Call"></a>
            <a href="#" class="nav-icon"><img src="./image/contact.png" alt="Contact"></a>
            <a href="cart.php" class="nav-icon"><img src="./image/cart.png" alt="Cart"></a>
